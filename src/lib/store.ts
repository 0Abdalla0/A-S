...
const KEYS = {
  ...
  msg: "engagement.messages",
  draw: "engagement.drawings",
  voice: "engagement.voice",
} as const;
...
function write<T>(k: string, v: T[]) {
  ...
  window.dispatchEvent(new CustomEvent("engagement-store-update", { detail: k }));
}
...
export const store = {
  ...
  clearAll: () => {
    ...
    window.dispatchEvent(new CustomEvent("engagement-store-update"));
  },
};
